  ...
  <div class="wrapper">
   ...
   <main class="main">
     ...
     <div class="main-photo">
       <img src="../assets/office_photo.png" alt="">
     </div>
     <div class="info-block">
       <div class="info-text">
         <div class="info-text-item first-item">
          <h3>Who we are</h3>
          <ul>
         ...
         <div class="info-text-item second-item">
          <h3>What we do</h3>
          <ul>
         ...
         <div class="info-text-item third-item">
          <h3>Technology</h3>
          <ul>
            <li>The point of using Lorem Ipsum</li>
            <li>As opposed to using 'Content here, content here'</li>
   ...
   <footer class="footer">
     <div id="write-comment">
       ...
       <div class="main-form">
         <form action="https://5cbef81d06a6810014c66193.mockapi.io/api/comments" method="post" @submit.prevent="commentPost">
           <input type="text" v-model="rmdatafo.title" placeholder="Title">
           <input type="textarea" v-model="dataform.body" placeholder="Your comment">
     ...
     <div class="contacts">
       <div class="email-phone">
         <p><a href="mailto:mail@mailtest.com">mail@mailtest.com</a></p>
        <p><a href="tel:+30-6977664062">+30-6977664062</a></p> 
       </div>
       <div class="copyright">
...
export default {
  ...
  created() {
    axios.get('https://5cbef81d06a6810014c66193.mockapi.io/api/comments/50')
    .then(response => {
...
.info-text-item ul li {
  padding-bottom: 20px;
}
.info-text-item ul li:last-child {
  padding-bottom: 0;
}
.info-text-item {
  color: #101417;
...
.first-item h3::before {
  position: absolute;
  content: "";
  top: 0;
  left: 0;
  background-image: url('../assets/users-icon.png');
  width: 40px;
  height: 29px;
}
.second-item h3::before {
  position: absolute;
  content: "";
  top: 0;
  left: 0;
  background-image: url('../assets/comp_icon.png');
  width: 40px;
  height: 34px;
}
.third-item h3::before {
  position: absolute;
  content: "";
  top: 0;
  left: 0;
  background-image: url('../assets/detail_icon.png');
  width: 36px;
  height: 37px;
}
footer.footer {
